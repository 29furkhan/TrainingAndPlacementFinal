...
function searchActivityStudents(ip) {
  var input, filter, table, tr, td, i,alltables;
  alltables = document.querySelectorAll("table[data-name=activitystudentstable]");
  input = document.getElementById(ip);
  filter = input.value.toUpperCase();
  alltables.forEach(function(table){
    tr = table.getElementsByTagName("tr");
...
function searchDriveStudents(ip) {
  var input, filter, table, tr, td, i,alltables;
  alltables = document.querySelectorAll("table[data-name=companystudenttable]");
  input = document.getElementById(ip);
  filter = input.value.toUpperCase();
  alltables.forEach(function(table){
    tr = table.getElementsByTagName("tr");
