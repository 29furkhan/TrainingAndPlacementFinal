            ...
            <div style="width:170px;display:flex;justify-content:space-between;flex-wrap:wrap;">
                <div>
                    <form action='/php/activity/download'>
                        ...
                        <button type="submit" id="exportactivity{{$as->Activity_ID}}" data-toggle="tooltip" title="Download Excel Sheet!" style="border-radius:0;width:40px;"  class="dwnld btn btn-primary">
                            <i style="font-size:17px;" class="fa fa-download"> </i>
                        </button>
                    </form>
                </div>
                <div>
                    <button type="button"  id="editActivityBtn{{$as->Activity_ID}}" title="Edit the Activity!" style="border-radius:0;margin-right:15px;" class="edt btn btn-primary">
                        <i style="font-size:17px;" class="fa fa-pencil"> </i>
                    </button>
                    <button id="deleteActivityBtn{{$as->Activity_ID}}" type="button" data-toggle="modal" title="Delete Activity!" style="border-radius:0;margin-right:15px;"  class="dlt btn btn-primary">
