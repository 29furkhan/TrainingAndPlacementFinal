...
class PaymentsController extends Controller
{
    ...
    public function paytmCallback( Request $request ) {
        ...
        Debugbar::info("Me yaha Poch Gaya");
		if ( 'TXN_SUCCESS' === $request['STATUS'] ) {
			$transaction_id = $request['TXNID'];
			$order = Payments::where( 'order_id', $order_id )->first();
    ...
    public function store(Request $request)
    {
        ...
        $order->amount = ($request->amount) ? $request->amount : '';
	    ...
	    return view( 'pages.paytm-merchant-form', compact( 'paytm_txn_url', 'paramList', 'checkSum' ) );
    ...
    public function handlePaytmRequest( $order_id, $amount ) {
		...
		$paramList["MID"] = 'BYIaoL12933512274460';
		...
		$paytm_merchant_key = 'qlb#5KqGALFElR9J';
